...
REQUIRED_PKGS="ca-certificates git binutils libasound2-dev libva2 libpcre3-dev libidn11-dev libboost-dev libfreetype6-dev libdbus-1-dev libssl-dev libssh-dev libsmbclient gcc g++ sed pkg-config"
MISSING_PKGS=""
